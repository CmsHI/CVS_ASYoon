...
void plot_eff_vs_general_var_grand_pas(Bool_t rebin=false, Bool_t range=false){
   ...
   if(variable==1){
     ...
     TH1F *dum = new TH1F("dum","",100,0.5,210); 
   ...
   */
   ...
   if(!MBonly){
     ...
     //TLegend *leg = new TLegend(0.23,0.25,0.74,0.47);
     //TLegend *leg = new TLegend(0.23,0.26,0.68,0.64); 
     //TLegend *leg = new TLegend(0.23,0.26,0.71,0.64);        
     TLegend *leg = new TLegend(0.23,0.26,0.70,0.68);
     leg->SetHeader("  PYTHIA 7 TeV");
     leg->SetBorderSize(0);
      ...
      */
      ...
      leg->AddEntry(Eff4Skm,jetrange3,"lp");
      leg->AddEntry(dum,"  #hat{p_{T}} #geq 15 GeV/c ","");
      leg->AddEntry(dum,"   ","");


      leg->AddEntry(Eff6Skm,jetrange4,"lp");
      leg->AddEntry(dum,"  #hat{p_{T}} #geq 30 GeV/c","");
      leg->AddEntry(dum,"   ","");
      ...
      leg->AddEntry(Eff8Skm,jetrange6,"lp");
      leg->AddEntry(dum,"  #hat{p_{T}} #geq 80 GeV/c","");
      leg->AddEntry(dum,"   ","");

      leg->AddEntry(Eff10Skm,jetrange7,"lp");
      leg->AddEntry(dum,"  #hat{p_{T}} #geq 170 GeV/c","");
      leg->AddEntry(dum,"   ","");

      leg->AddEntry(Eff12Skm,jetrange9,"lp");
      leg->AddEntry(dum,"  #hat{p_{T}} #geq 300 GeV/c","");
      leg->AddEntry(dum,"   ","");
   ...
   TLatex * ctex;
   ctex = new TLatex(0.62,0.90,"CMS Preliminary");
   ...
   texA->Draw();
     ...
     sprintf(outName1,"Eff_FR_GRAND_wider_v2_loose");
     Char_t outName2[100];
     //sprintf(outName2,"Eff_FR_GRAND_logx_%s",VARIABLE);
     sprintf(outName2,"Eff_FR_GRAND_logx_wider_v2_loose");
