...
void plotHist() {
  ...
  //TFile *f = new TFile("../root_files/TrkHistGEN_900GeV_aug31_qcdMB10MD6T7TeVJetV2.root");
  //TFile *f = new TFile("../root_files/TrkHistGEN_900GeV_oct26v2_qcdMBD6TV2.root");
  TFile *f = new TFile("../root_files_postApp/mc/TrkHistGEN_oct06_qcdMBD6TV1.root");

  double maxpT = 10;

  // sim-to-reco hists                                                                     
  TH2F *hSim = (TH2F*) f->Get("trkEffAnalyzer/hsim"); hSim->GetYaxis()->SetRangeUser(0,maxpT);
  TH2F *hAcc = (TH2F*) f->Get("trkEffAnalyzer/hacc"); hAcc->GetYaxis()->SetRangeUser(0,maxpT);
  TH2F *hEff = (TH2F*) f->Get("trkEffAnalyzer/heff"); hEff->GetYaxis()->SetRangeUser(0,maxpT);
  TH2F *hMul = (TH2F*) f->Get("trkEffAnalyzer/hmul"); hMul->GetYaxis()->SetRangeUser(0,maxpT);

  // reco-to-sim hists                                                                                                                                                                            
  TH2F *hRec = (TH2F*) f->Get("trkEffAnalyzer/hrec"); hRec->GetYaxis()->SetRangeUser(0,maxpT);
  TH2F *hFak = (TH2F*) f->Get("trkEffAnalyzer/hfak"); hFak->GetYaxis()->SetRangeUser(0,maxpT);
  TH2F *hSec = (TH2F*) f->Get("trkEffAnalyzer/hsec"); hSec->GetYaxis()->SetRangeUser(0,maxpT);
  ...
  */
  ...
  // sim-to-reco hists 
  /*
  TH2F *hSim = (TH2F*) f->Get("loosetrkEffAnalyzer/hsim"); hSim->GetYaxis()->SetRangeUser(0,10);
  TH2F *hAcc = (TH2F*) f->Get("loosetrkEffAnalyzer/hacc"); hAcc->GetYaxis()->SetRangeUser(0,10);
  TH2F *hEff = (TH2F*) f->Get("loosetrkEffAnalyzer/heff"); hEff->GetYaxis()->SetRangeUser(0,10);
  TH2F *hMul = (TH2F*) f->Get("loosetrkEffAnalyzer/hmul"); hMul->GetYaxis()->SetRangeUser(0,10);

  // reco-to-sim hists 
  TH2F *hRec = (TH2F*) f->Get("loosetrkEffAnalyzer/hrec"); hRec->GetYaxis()->SetRangeUser(0,10);
  TH2F *hFak = (TH2F*) f->Get("loosetrkEffAnalyzer/hfak"); hFak->GetYaxis()->SetRangeUser(0,10);
  TH2F *hSec = (TH2F*) f->Get("loosetrkEffAnalyzer/hsec"); hSec->GetYaxis()->SetRangeUser(0,10);
  */
  ...
  TH1D* hDumPt = new TH1D("hDumPt",";p_{T} [GeV/c]",80,0.0,maxpT); hDumPt->SetMaximum(1.0);
  ...
  TLegend *legEta = new TLegend(0.43,0.29,0.72,0.5);
  legEta->SetFillColor(0); legEta->SetBorderSize(0);
  legEta->SetHeader("     PYTHIA 7 TeV");
  ...
  */
  ...
  //peff_preliminary
  printCanvases(call,"peff_final",0);  
  /*
  printCanvases(c1,"trk_acceptance_fraction_7000GeV",0);
  printCanvases(c2,"trk_reco_eff_fraction_7000GeV",0);
  printCanvases(c3,"trk_mult_reco_fraction_7000GeV",0);
  printCanvases(c4,"trk_fake_reco_fraction_7000GeV",0);
  printCanvases(c5,"trk_sec_fraction_7000GeV",0);

  printCanvases(c6,"trk_acceptance_fraction_eta_pt_7000GeV",0);
  printCanvases(c7,"trk_reco_eff_fraction_eta_pt_7000GeV",0);
  printCanvases(c8,"trk_mult_reco_fraction_eta_pt_7000GeV",0);
  printCanvases(c9,"trk_fake_reco_fraction_eta_pt_7000GeV",0);
  printCanvases(c10,"trk_sec_fraction_eta_pt_900GeV",0);
  */
