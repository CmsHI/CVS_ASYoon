...
def runOn440DataMixMC(process):
    print "runOn440DataMixMC option is enabled (the whole event filtering removed)!"
    process.eventFilter.remove(process.minBiasBscFilter)
    process.eventFilter.remove(process.spikeCleaning)
    process.eventFilter.remove(process.collisionEventSelection)
    process.primaryVertexFilter.cut=cms.string("!isFake && abs(z) <= 15 && position.Rho <= 2")
    process.hltMinBias.TriggerResultsTag=cms.InputTag('TriggerResults','','MIX')
    process.hltJets.TriggerResultsTag=cms.InputTag('TriggerResults','','MIX')
    process.hitrackAna.triglabel=cms.untracked.InputTag('TriggerResults','','MIX')
    process.hitrackAna_jetMode1.triglabel=cms.untracked.InputTag('TriggerResults','','MIX')
    process.hitrackAna_jetMode2.triglabel=cms.untracked.InputTag('TriggerResults','','MIX')
    process.hitrackAna_jetMode3.triglabel=cms.untracked.InputTag('TriggerResults','','MIX')
    process.hitrackAna_jetMode4.triglabel=cms.untracked.InputTag('TriggerResults','','MIX')
    process.higoodlooseAna.triglabel=cms.untracked.InputTag('TriggerResults','','MIX')
    process.higoodlooseAna_jetMode1.triglabel=cms.untracked.InputTag('TriggerResults','','MIX')
    process.higoodlooseAna_jetMode2.triglabel=cms.untracked.InputTag('TriggerResults','','MIX')
    process.higoodlooseAna_jetMode3.triglabel=cms.untracked.InputTag('TriggerResults','','MIX')
    process.higoodlooseAna_jetMode4.triglabel=cms.untracked.InputTag('TriggerResults','','MIX')
    process.hihightrackAna.triglabel=cms.untracked.InputTag('TriggerResults','','MIX')
    process.hihightrackAna_jetMode1.triglabel=cms.untracked.InputTag('TriggerResults','','MIX')
    process.hihightrackAna_jetMode2.triglabel=cms.untracked.InputTag('TriggerResults','','MIX')
    process.hihightrackAna_jetMode3.triglabel=cms.untracked.InputTag('TriggerResults','','MIX')
    process.hihightrackAna_jetMode4.triglabel=cms.untracked.InputTag('TriggerResults','','MIX')
    process.hicaloTrackAna.triglabel=cms.untracked.InputTag('TriggerResults','','MIX')
    process.hipxltrackAna.triglabel=cms.untracked.InputTag('TriggerResults','','MIX')
    process.hirefitTrackAna.triglabel=cms.untracked.InputTag('TriggerResults','','MIX')
    process.preTrgAna.triglabel=cms.untracked.InputTag('TriggerResults','','MIX')
    process.postTrgAna.triglabel=cms.untracked.InputTag('TriggerResults','','MIX')
    process.postEvtAna.triglabel=cms.untracked.InputTag('TriggerResults','','MIX')
    process.preTrgAna.gtrklabel=cms.untracked.InputTag("genParticles")
    process.postTrgAna.gtrklabel=cms.untracked.InputTag("genParticles")
    process.postEvtAna.gtrklabel=cms.untracked.InputTag("genParticles")
    process.hitrackAna.gsrc=cms.untracked.InputTag("genParticles")
