...
enableHLTJet(process,"HLT_HIJet65_v1") # HLT and jet ET range customize
...
process.preTrigCentDist.applyStrechFact = cms.untracked.double(1.26) # to compare 2010 and 2011 HF distribution
process.postTrigCentDist.applyStrechFact = cms.untracked.double(1.26)
process.postEvtCentDist.applyStrechFact = cms.untracked.double(1.26)
process.extraCentDist.applyStrechFact = cms.untracked.double(1.26)
...
process.eventFilter.replace(process.hltJets,process.hltJets*process.jetEvtFilter) # jet eta cut (not applied in skim)
process.extraTrks_step.remove(process.hiOptimalTightTracks) # SimpleTrackListMerger not working (need hack)
process.hiAnalysisSeq.remove(process.higoodtrkval) # crash observed
process.hiAnalysisSeq.remove(process.higoodtrkval_pt80) # crash observed
process.hiAnalysisSeq.remove(process.higoodtrkval_pt100) # crash observed
process.hiAnalysisSeq.remove(process.higoodtrkval_pt120) # crash observed   
