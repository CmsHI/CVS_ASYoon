#-----------------------------------------------------------------
# cfg - to do tracking reconstruction on DM sample (sig only)
#       and to produce hiOptimalTightTracks in old way (i.e 39X)
...
process.iterTrack_step   = cms.Path(process.pdigi * 
                                    process.SimL1Emulator * 
                                    process.DigiToRaw * #process.DigiToRawTracker (for MIX)
                                    process.RawToDigi * #process.RawToDigiTracker (for MIX)
...
process.higoodtrkval.trklabel = cms.untracked.InputTag("hiOptimalTightTracks",'','SIGNAL')
