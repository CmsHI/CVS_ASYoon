...
//  Double_t y7[2] =  {  2.36, 3.80 };  // from Yen-Jie PAS (PYTHIA)
  ...
  */
    ...
    if(bw) {
       //TLegend leg(0.15,0.51,0.39,0.85);
       //TLegend leg(0.22,0.55,0.46,0.89);
       //TLegend leg(0.22,0.52,0.5,0.91); 
       TLegend leg(0.22,0.44,0.6,0.911); 
       leg.SetFillColor(0);
       leg.SetFillStyle(0);
       //TLegend *leg2 = new TLegend(0.22,0.48,0.6,0.911,NULL,"brNDC");
    }
    else   {
       TLegend leg(0.15,0.58,0.55,0.85);
