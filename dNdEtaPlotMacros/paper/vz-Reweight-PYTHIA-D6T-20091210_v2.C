...
//=========  (Wed Dec 16 14:37:41 2009) by ROOT version5.22/00a
   TCanvas *c1 = new TCanvas("c1", "c1",3,92,550,600);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   ...
   TLegend *leg = new TLegend(0.1886447,0.7867133,0.5879121,0.9265734,NULL,"brNDC");
   leg->SetBorderSize(0);
   leg->SetTextFont(62);
   leg->SetLineColor(1);
   leg->SetLineStyle(1);
