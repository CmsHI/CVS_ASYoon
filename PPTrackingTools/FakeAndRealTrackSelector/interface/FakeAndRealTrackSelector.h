#ifndef PPTrackingTools_FakeAndRealTrackSelector_h
#define PPTrackingTools_FakeAndRealTrackSelector_h

/** \class FakeAndRealTrackSelector
 *
 * 
 * 
 * 
...
namespace reco { namespace modules {
    ...
    class FakeAndRealTrackSelector : public edm::EDProducer {
        private:
        public:
            /// constructor 
            explicit FakeAndRealTrackSelector( const edm::ParameterSet & cfg ) ;
            /// destructor
            virtual ~FakeAndRealTrackSelector() ;
