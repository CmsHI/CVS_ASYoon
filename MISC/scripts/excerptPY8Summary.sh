...
outputDir=xsection
outputName=pythia8_2760GeV_feb142011
...
while read inputline
  do 
    ...
    outputfile="$PWD/$filename/res/CMSSW_2.stdout" 
...
grep "sum" ./xsection/*.txt | awk '{print $1,$9}' | sed s/D/E/g > ./xsection/xsection_$outputName.dat