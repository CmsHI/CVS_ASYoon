...
ivars.inputFiles = 'file:/home/sungho/sctch101/data/dm/preMix.root'

ivars.outputFile = '/home/sungho/sctch101/data/dm/pgunMix_test_custom_ivan.root'
...
process.GlobalTag.globaltag = 'MC_42_V14A::All'
...
#process = customiseSiStripConditions(process)
...
#process.mixData.SiStripRawDigiSource = cms.string('PILEUP')
