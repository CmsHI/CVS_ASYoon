...
ivars.files = "dcache:/pnfs/cmsaf.mit.edu/t2bat/cms/store/user/y_alive/spectra/firstHi2010/data/HCPR_IterTrkCT_OptTight_SkimLight_proc1310/hcpr_spectra_v2_jet50u_skim_v1/trkAnaSkimAODSIM_35_splited_list_hcp_prv3_ak.root"
...
process.extraTrks_step   = cms.Path(process.hiGoodTightTracks)
process.ana_step         = cms.Path(process.postEvtSelTest * process.hiAnalysisSeq) 
...
process.ana_step_extra = cms.Path((process.hitrackAnaSnd
