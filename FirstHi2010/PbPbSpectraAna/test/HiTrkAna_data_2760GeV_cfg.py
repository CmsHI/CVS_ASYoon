...
process.source = cms.Source("PoolSource",
  ...
  #fileNames = cms.untracked.vstring('file:trkAnaSkimAODSIM_v1.root')                            
)
...
process.extraTrks_step   = cms.Path(process.hiGeneralDerivedTracks * process.hiGeneralCaloTracks * process.hiGeneralCaloHybridTracks)
...
process = runWithIterTrk(process,"hiGeneralTracks") # use trk coll. from iterative trk
