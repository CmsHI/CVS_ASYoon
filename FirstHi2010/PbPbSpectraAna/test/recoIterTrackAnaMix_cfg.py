...
process.hitrkEffAnalyzer.tracks = cms.untracked.InputTag('hiOptimalTightTracks')
process.hitrkEffAnalyzer.usePxlPair = cms.untracked.bool(True)
process.hitrackAna.src = cms.untracked.InputTag('hiOptimalTightTracks')
process.hitrackAna.src_evtCorr = cms.untracked.InputTag('hiOptimalTightTracks')
