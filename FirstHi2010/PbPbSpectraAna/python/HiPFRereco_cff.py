...
trackerDrivenElectronSeeds.TkColList = cms.VInputTag("hiPostGlobalPrimTracks")
...
trkfilter = cms.EDFilter("PtMinTrackSelector",
                         src = cms.InputTag("hiPostGlobalPrimTracks"), # track collection inclusive of (hiGoodTight,Loose,HighPt)
