...
void dNdEta_vs_roots_fit() {
  ...
  //gre->SetPoint(++ip,7000,5.82);
  //gre->SetPointError(ip,0,0.133); // use 2.3% as in 2360 GeV 
  gre->SetPoint(++ip,7000,5.78); 
  gre->SetPointError(ip,0,5.78*0.04019);
