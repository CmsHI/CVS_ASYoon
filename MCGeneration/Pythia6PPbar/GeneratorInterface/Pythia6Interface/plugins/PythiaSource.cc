  ...
  if(particleID || particleIDs.size() > 1 ) 
    {
       ...
       call_pyinit( "NONE", "p", "pbar", comenergy ); // Modified by A.S.Yoon Oct 22 2009
    } else {
       //call_pyinit( "CMS", "p", "p", comenergy );
       call_pyinit( "CMS", "p", "pbar", comenergy ); // Modified by A.S.Yoon Oct 22 2009
    }
