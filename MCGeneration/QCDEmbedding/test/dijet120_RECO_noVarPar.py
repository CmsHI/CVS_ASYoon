...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring("file:/d01/y_alive/spectra/mc/embedding/embedded__Z2_Pt120_GEN_SIM_000B5EC7-60FA-E011-97E9-0002C90B741E.root")
)
...
process.RECODEBUGoutput = cms.OutputModule("PoolOutputModule",
    ...
    eventAutoFlushCompressedSize = cms.untracked.int32(5242880),
     ...
     fileName = cms.untracked.string("embeddedDiJet_RECO.root"),
    dataset = cms.untracked.PSet(
