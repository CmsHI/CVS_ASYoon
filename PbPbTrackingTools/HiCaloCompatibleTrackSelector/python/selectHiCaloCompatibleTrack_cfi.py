...
selectHiCaloCompatibleTrack  = cms.EDProducer("HiCaloCompatibleTrackSelector",
              ...
              caloCut = cms.untracked.double(0.3), # (calo energy sum/track pt) > caloCut (0 - loose, 1.0 - tight)
              ...
              funcCaloComp = cms.string("0.087/(1.0+0.1*exp(-0.28*(x-20.)))"), # root syntax, pt dependent calo-compatibility cut
