...
void CorrectTypeTwoNSave(const char *cDir="../root_files/",   // root file for mom. res.
			 ...
			 )
{
   ...
   resCorrF = new TF1("CorrectionFunction","pol4",0.1,maxpT);
   resCorrF->SetParameters(1.00418,-6.5107e-05,4.36783e-06,-4.29539e-08,1.50819e-10); // parameters are obtained from a separate macro
