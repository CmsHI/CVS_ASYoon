...
TrackSpectraAnalyzerHist::prepareHist()
{
   ...
   // spectra (with jet et)
   hTrkPtEtaMB = new TH3F("hTrkPtEtaMB","",
			  200,-2.5,2.5,2000,0,500,2000,0,500); 


   hTrkPtEta6U = new TH3F("hTrkPtEta6U","",
                          200,-2.5,2.5,2000,0,500,2000,0,500);
...
void
TrackSpectraAnalyzerHist::fillTrack2DHist(float eta, float pt){
